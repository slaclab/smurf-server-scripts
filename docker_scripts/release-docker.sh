...
usage()
{
    ...
    echo "                           - system3        : [OBSOLETE] Full system (stable version) [smurf2mce/rogue v3]."
    echo "                           - system3-dev-fw : [OBSOLETE] Full system (with a development version of FW) [smurf2mce/rogue v3]."
    echo "                           - system3-dev-sw : [OBSOLETE] Full system with a development version of SW and FW [smurf2mce/rogue v3]."
